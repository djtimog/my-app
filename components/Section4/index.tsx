    ...
    return(
        <>
            <section className={` w-100 p-4 p-sm-5 py-5`}>
                ...
                <div className="bottom-avatar w-100 d-flex justify-content-between">
                    <div>
                        <Image src={thirdAvatar} alt={`avatar`} title={"I can design you website"} className="d-block d-lg-none" width={70} height={70}/>
                        <Image src={lgThirdAvatar} alt={`avatar`} className="bigthird d-none d-lg-block"/>
                    </div>
                    <div>
                        ...
                        <Image src={lgFourthAvatar} alt={`avatar`} className="bigfourth d-none d-lg-block"/>
                    </div>
                    <div>
                        <Image src={fifthAvatar} alt={`avatar`} title={"I can prototype your app"} className="d-block d-lg-none" width={70} height={70}/>
                        <Image src={lgFifthAvatar} alt={`avatar`} className="bigfifth d-none d-lg-block"/>
                    </div>
                </div>
            </section>
        </>
